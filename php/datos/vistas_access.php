...
class vistas_access extends toba_datos_relacion
{
    ...
    public static function get_vista_access($filtro = array())
    {
        $where = array();
    ...
    public static function get_CHECKINOUT($filtro = array())
    {
 ...
 */
    ...
    public function get_marcas($filtro = array())
    {
...
//break;
    ...
    public static function get_dispositivos()
    {
    ...
    public static function get_dispositivos_dependencia($cod_depcia)
    {
        $sql = "SELECT M.ID as id_dispositivo,
		M.MachineAlias,
		M.area_id,
    ...
    public function dividir_horas($horas_dividendo, $divisor)
    {
    ...
    public function get_lista_resumen($personas, $filtro = array())
    {
        $total = 0;
    ...
    public function calculo_dia($dia_ref, $dia_leyenda, $key, &$agentes, &$array_marcas, &$contador_marcas, $dia, $filtro_marca)
    {
    ...
    public function calculo_horas_req($hora_min, $dias)
    {
